...
public class TMXObjectGroup implements TMXConstants {
	...
	public TMXObjectGroup(final Attributes pAttributes) {
		...
		this.mWidth = SAXUtils.getIntAttribute(pAttributes, TMXConstants.TAG_OBJECTGROUP_ATTRIBUTE_WIDTH, 1);
		this.mHeight = SAXUtils.getIntAttribute(pAttributes, TMXConstants.TAG_OBJECTGROUP_ATTRIBUTE_HEIGHT, 1);
	}
